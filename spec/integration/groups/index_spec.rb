...
RSpec.describe 'Groups index page', type: :feature do
  before(:each) do
    ...
    @group1 = Group.create(name: 'my group 1st', icon: 'www.myicon/path/icon.png', author: @user)
    @group2 = Group.create(name: 'my group 2nd', icon: 'www.myicon/path/icon.png', author: @user)
